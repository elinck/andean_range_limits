...
A character-to-numeric column change is necessary:
...
Finally, we calculate secondary blood indices, add an Arctos URL, reorder in a pleasing way, and export as a `.csv`:
