...
slope_hb_1 <- 
  brm(data = slope_df, family = student(),
      ...
      inits = inits_list,
      prior = c(
        prior(normal(0, 0.5), "b", coef="elev_range_s"),
        prior(normal(0, 0.5), "b", coef="median_elevation_s"),
        prior(normal(0, 0.5), "b", coef="elev_range_s:median_elevation_s"),
        prior(normal(0, 0.5), "b", coef="sampling_range_s"),
        prior(normal(0, 0.5), "b", coef="mass_s"),
